...
const priorityButtons = document.querySelectorAll<HTMLButtonElement>('.priority-group .priority');
// Hidden input that stores the currently selected priority
const priorityInput = document.getElementById('task-priority') as HTMLInputElement;
